                ...
                <form action="{{ url('register') }}" method="POST" class="d-flex flex-column justify-content-center h-100 p-3 p-md-5 bg-white">
                    ...
                    <div class="mb-3">
                        <div class="input-group">
                            ...
                            <input type="password" name="password" class="form-control bg-light border-start-0 @error('password') is-invalid @enderror" placeholder="Mật khẩu (Tối thiểu 8 ký tự)" required>
                        </div>
                    ...
                    <div class="mb-4">
                        <div class="input-group">
                            ...
                            <input type="password" name="password_confirmation" class="form-control bg-light border-start-0" placeholder="Xác nhận mật khẩu" required>
                        </div>
                    </div>
            ...
            <div class="form-container sign-in-container">
                <form action="{{ route('login') }}" method="POST" class="d-flex flex-column justify-content-center h-100 p-3 p-md-5 bg-white">
                    ...
                    <div class="mb-2">
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0 text-muted"><i class="bi bi-key"></i></span>
                            <input type="password" name="password" class="form-control bg-light border-start-0 @error('password') is-invalid @enderror" placeholder="Nhập mật khẩu" required>
                        </div>
                        @error('password') <div class="text-danger small mt-1 fw-bold">{{ $message }}</div> @enderror
                    </div>
            ...
            <div class="overlay-container d-none d-md-block">
                <div class="overlay">
                    ...
                    <div class="overlay-panel overlay-left">
                        ...
                        <h2 class="serif-title mb-3 fw-bold text-white">Chào mừng trở lại!</h2>
